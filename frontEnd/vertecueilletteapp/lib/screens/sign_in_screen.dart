        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Container(
                  ...
                  child: const Align(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Farm to Table', style: TextStyle(color: Colors.white, fontSize: 18)),
                        SizedBox(height: 6),
                        Text(
              ...
              const Text('Welcome Back', style: TextStyle(fontSize: 34, fontWeight: FontWeight.w800, color: AppColors.dark)),
...
onPressed: isLoading ? null : () => _login(),
              ...
              const Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text('OR CONTINUE WITH', style: TextStyle(color: AppColors.textGrey, fontWeight: FontWeight.w700)),
                  ),
                  Expanded(child: Divider()),
                ],
              ),
              ...
              Center(
                child: Wrap(
                  ...
                  children: [
                    const Text("Don't have an account yet? ", style: TextStyle(color: AppColors.textGrey)),
                    GestureDetector(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text('New Picker Discount', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800)),
                          const SizedBox(height: 8),
                          const Text(
                          ...
                          TextButton(
                            onPressed: () {},
                            child: const Text('Learn more', style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.w800)),
                          )
                        ],
                      ),
                    )
